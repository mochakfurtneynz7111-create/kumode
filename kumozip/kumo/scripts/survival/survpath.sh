...
feat='extracted-vit_large_patch16_224.dinov2.cnn_mass100k'
input_dim=1024
mag='20x'
patch_size=256

bag_size=4096
batch_size=64 # 从 1 改为 64
out_size=16
out_type='allcat'
...
opt='adamW'
grad_accum=1
loss_fn='cox' # ← 从 'nll' 改为 cox (如果之前是 nll)
n_label_bin=4
alpha=0.5
em_step=1
load_proto=1
...
# Multimodal args
model_mm_type='coattn'    # 'coattn', 'coattn_mot', 'histo', 'gene'   #从 'survpath' 改为 coattn
append_embed='random'
histo_agg='mean'
num_coattn_layers=1
