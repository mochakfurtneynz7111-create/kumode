...
all_feat_dirs="/root/autodl-tmp/MMP/ALL_embeddings/ALL_COADREAD_embeddings/extracted_mag20x_patch256_fp/extracted-vit_large_patch16_224.dinov2.uni_mass100k/feats_pt"
